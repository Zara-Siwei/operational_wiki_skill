...
description: |
  Evidence-first operational wiki for textbooks, papers, large Markdown/HTML files, and software documentation snapshots. Supports full-text search, relationship graphs, concept maturity tracking, source freshness detection, and batch ingest. Use when Codex needs to ingest, query, search, or maintain a mixed research knowledge base that should stay readable while becoming slightly more structured: stable concept pages, tool/api pages, typed relations, explicit evidence, and traceable raw sources. Trigger for requests like “收录资料”, “整理文档站”, “搜索wiki里的概念”, “画关系图谱”, “检查wiki健康状态”, or “批量收录raw目录下的论文”.
---
...
核心机制:
  - 全文搜索 (search.py)
  - 关系图谱 (graph.py, Mermaid 格式)
  - 概念成熟度 (stub/partial/mature)
  - raw 文件过期检测 (SHA256 指纹)
  - 批量摄入模式 (≥3 个未登记文件)
  - 统计同步 (stats.py)
  - Evidence 回溯 + typed relations
